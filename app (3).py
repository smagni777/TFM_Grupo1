...
<style>
    ...
    /* Banner de cabecera (silueta de Madrid) */
    .madrid-banner {
        border-radius: 14px;
    ...
    /* Niveles de severidad del simulador de escenarios */
    .level-box {
        padding: 18px;
        border-radius: 8px;
...
def banner_madrid():
    """
    Cabecera visual con una silueta esquemática de monumentos de
    Madrid (Puerta de Alcalá, Fuente de Cibeles, Edificio Metrópolis,
    Palacio Real / Catedral de la Almudena y Torres KIO).

    Es una ilustración vectorial original, no una fotografía, para
    evitar cualquier problema de derechos de autor y mantener una
    estética sobria y coherente con el resto del dashboard.
    """
    st.markdown(
        """
        ...
        <svg viewBox="0 0 1200 230" xmlns="http://www.w3.org/2000/svg"
          ...
          <title>Silueta esquemática de monumentos de Madrid</title>
          <desc>
              Ilustración de la Puerta de Alcalá, la Fuente de Cibeles,
              el Edificio Metrópolis, el Palacio Real con la Catedral
              de la Almudena y las Torres KIO.
          </desc>
          <defs>
          ...
          <rect x="0" y="0" width="1200" height="230" rx="16" fill="url(#skyGrad)"/>
          <rect x="24" y="196" width="1152" height="3" fill="#c9d3e0"/>

          <g fill="#c3ceDD">
            <rect x="24"  y="160" width="26" height="36"/>
            <rect x="54"  y="145" width="22" height="51"/>
            <rect x="80"  y="168" width="18" height="28"/>
          </g>

          <g fill="#17365D">
            <rect x="118" y="86" width="190" height="12" rx="2"/>
            <circle cx="138" cy="76" r="6"/>
            <circle cx="213" cy="72" r="7"/>
            <circle cx="288" cy="76" r="6"/>
            <rect x="118" y="98" width="190" height="98"/>
          </g>
          <g fill="#eef2f8">
            <path d="M 138 196 L 138 150 A 20 20 0 0 1 178 150 L 178 196 Z"/>
            <path d="M 193 196 L 193 138 A 26 26 0 0 1 245 138 L 245 196 Z"/>
            <path d="M 250 196 L 250 150 A 20 20 0 0 1 290 150 L 290 196 Z"/>
          </g>

          <g>
            <ellipse cx="400" cy="192" rx="46" ry="10" fill="#17365D"/>
            <ellipse cx="400" cy="188" rx="34" ry="7" fill="#eef2f8"/>
            <rect x="392" y="150" width="16" height="40" fill="#17365D"/>
            <path d="M 378 150 Q 400 118 422 150 Z" fill="#17365D"/>
            <circle cx="400" cy="122" r="7" fill="#1967D2"/>
            <path d="M 364 168 Q 376 158 384 168" stroke="#1967D2" stroke-width="2" fill="none"/>
            <path d="M 416 168 Q 424 158 436 168" stroke="#1967D2" stroke-width="2" fill="none"/>
          </g>

          <g fill="#17365D">
            <rect x="520" y="94" width="58" height="102"/>
            <path d="M 520 94 Q 549 56 578 94 Z"/>
            <rect x="546" y="40" width="6" height="18"/>
            <circle cx="549" cy="36" r="6" fill="#1967D2"/>
          </g>
          <g fill="#1967D2">
            <circle cx="536" cy="120" r="3"/>
            <circle cx="562" cy="120" r="3"/>
            <circle cx="536" cy="142" r="3"/>
            <circle cx="562" cy="142" r="3"/>
            <circle cx="536" cy="164" r="3"/>
            <circle cx="562" cy="164" r="3"/>
          </g>

          <g fill="#17365D">
            <rect x="650" y="140" width="230" height="56"/>
            <polygon points="650,140 880,140 865,120 665,120"/>
            <g fill="#eef2f8">
              <rect x="670" y="150" width="5" height="46"/>
              <rect x="700" y="150" width="5" height="46"/>
              <rect x="730" y="150" width="5" height="46"/>
              <rect x="760" y="150" width="5" height="46"/>
              <rect x="790" y="150" width="5" height="46"/>
              <rect x="820" y="150" width="5" height="46"/>
              <rect x="850" y="150" width="5" height="46"/>
            </g>
            <path d="M 878 140 A 34 34 0 0 1 946 140 Z"/>
            <rect x="908" y="96" width="8" height="20"/>
            <path d="M 905 96 L 919 96 L 912 84 Z"/>
          </g>

          <g fill="#17365D">
            <polygon points="1000,196 1000,110 1050,96 1050,196"/>
            <polygon points="1150,196 1150,110 1100,96 1100,196"/>
          </g>
          <g stroke="#1967D2" stroke-width="2">
            <line x1="1010" y1="196" x2="1010" y2="118"/>
            <line x1="1025" y1="196" x2="1024" y2="112"/>
            <line x1="1140" y1="196" x2="1140" y2="118"/>
            <line x1="1125" y1="196" x2="1126" y2="112"/>
          </g>

          <g fill="#c3ceDD">
            <rect x="960" y="172" width="20" height="24"/>
          </g>
        </svg>
        </div>
        """,
