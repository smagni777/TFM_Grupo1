...
<style>
    ...
    /* Banner de cabecera (mosaico fotográfico de Madrid) */
    .madrid-banner {
        position: relative;
        border-radius: 14px;
        overflow: hidden;
    ...
    .madrid-banner-overlay {
        ...
        background: linear-gradient(
            100deg,
            rgba(15,33,58,0.92) 0%,
            rgba(15,33,58,0.80) 45%,
            rgba(15,33,58,0.15) 85%,
            rgba(15,33,58,0) 100%
        );
    }
    ...
    .madrid-banner-credit {
        position: absolute;
        right: 10px;
        bottom: 8px;
        font-size: 10px;
        color: rgba(255,255,255,0.75);
        background: rgba(15,33,58,0.45);
        padding: 2px 8px;
        border-radius: 4px;
    }
    @media (max-width: 640px) {
        .madrid-banner { height: 220px; }
        .madrid-banner-overlay { max-width: 100%; padding: 18px 6%; }
        .madrid-banner-overlay h1 { font-size: 22px; }
        .madrid-banner-overlay h3 { font-size: 13px; }
    }
...
def banner_madrid():
    ...
    Todas las fotografías proceden de Pixabay (Pixabay Content
    License: uso libre para fines comerciales y no comerciales,
    sin necesidad de atribución).
    """
    fotos = [
        ("https://cdn.pixabay.com/photo/2017/03/27/18/43/madrid-2179954_1280.jpg", "Puerta de Alcalá"),
        ("https://cdn.pixabay.com/photo/2017/07/28/18/00/fountain-2549392_1280.jpg", "Fuente de Cibeles"),
        ("https://cdn.pixabay.com/photo/2015/08/01/19/34/madrid-870676_1280.jpg", "Fuente de Neptuno"),
        ("https://cdn.pixabay.com/photo/2015/10/02/19/46/gran-via-968932_1280.jpg", "Gran Vía / Edificio Metrópolis"),
        ("https://cdn.pixabay.com/photo/2018/06/08/12/58/royal-3462249_1280.jpg", "Palacio Real"),
        ("https://cdn.pixabay.com/photo/2014/10/08/20/00/torres-kio-480627_1280.jpg", "Torres KIO"),
    ]

    tiles_html = "".join(
        f'<img src="{url}" alt="{alt}" title="{alt}">'
        for url, alt in fotos
    )
    ...
    st.markdown(
        ...
        <div class="madrid-banner">
            ...
            <div class="madrid-banner-overlay">
                <h1>TUI Territorial Intelligence</h1>
                <h3>Plataforma de inteligencia georreferenciada para la gestión turística</h3>
                <p>Madrid · Oferta · Accesibilidad · Sostenibilidad · Oportunidades</p>
            </div>
            <div class="madrid-banner-credit">Fotografías: Pixabay (uso libre)</div>
        </div>
        """,
        unsafe_allow_html=True
    )
